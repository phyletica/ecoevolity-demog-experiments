...
\newcommand{\table}{Table\xspace}
\newcommand{\tables}{Tables\xspace}
...
\newcommand{\validationsimsthreecolumndescription}{The left column of plots
    ...
    The center and right column of plots show the true versus estimated
    (posterior mean) value of the time of the population size change when using
    all characters (center) or only variable characters (right).
}
