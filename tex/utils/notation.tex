...
\newcommand{\sdgamma}[2]{\ensuremath{\textrm{G}(#1, \textrm{mean} = #2)}}
\newcommand{\sdogamma}[3]{\ensuremath{\textrm{G}^{#3}(#1, \textrm{mean} = #2)}}
\newcommand{\sdexponential}[1]{\ensuremath{\textrm{E}(\textrm{mean} = #1)}}
...
\newcommand{\prelimsimcondition}[1][]{\textbf{\textit{PV#1}}\xspace}
\newcommand{\valsimcondition}[1][]{\textbf{\textit{V#1}}\xspace}
\newcommand{\missimcondition}[1][]{\textbf{\textit{S#1}}\xspace}

\newcommand{\psimfourinc}{\prelimsimcondition{1}\xspace}
\newcommand{\psimtwoinc}{\prelimsimcondition{2}\xspace}
\newcommand{\psimtwodec}{\prelimsimcondition{3}\xspace}
\newcommand{\psimcentered}{\prelimsimcondition{4}\xspace}
\newcommand{\psimnochange}{\prelimsimcondition{5}\xspace}

\newcommand{\vsimfourinc}{\valsimcondition{1}\xspace}
\newcommand{\vsimtwoinc}{\valsimcondition{2}\xspace}
\newcommand{\vsimfourdec}{\valsimcondition{3}\xspace}
\newcommand{\vsimcentered}{\valsimcondition{4}\xspace}
\newcommand{\vsimnochange}{\valsimcondition{5}\xspace}

\newcommand{\msimfourinc}{\missimcondition{1}\xspace}
\newcommand{\msimfourdec}{\missimcondition{2}\xspace}
\newcommand{\msimteninc}{\missimcondition{3}\xspace}
\newcommand{\msimtendec}{\missimcondition{4}\xspace}
