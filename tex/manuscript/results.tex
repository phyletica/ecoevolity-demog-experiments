...
It is also not surprising that sharing a demographic change event
with more populations does not increase the accuracy or precision of
the estimates of the timing of that event 
(\fig{}~S\ref{fig:sharedverror}), for two reasons:
...
showed that the amount of information about the timing of events
plateaus quickly as genomic data are collected.
