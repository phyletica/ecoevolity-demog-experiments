...
arbitrary mix of times of divergence and changes in population size.
However, if we focus only on changes in population size, the models underlying
the ABC methods of
\citet{Chan2014,Xue2015,Gehara2017}
...
The models of \citet{Chan2014,Xue2015,Gehara2017}
...
directly from the counts of allele patterns from each population, while
...
changes across species will effect multiple species with some amount of
temporal variation.
...
overestimate the number events by misidentifying the temporal variation among
...
that the posterior probabilities of models of events are similar to the prior
