\embedWidthFigure{1.0}{../images/model-cartoons/model-choice-island-cartoon-mixed-compressed.pdf}{
    A cartoon illustration of the general model-choice problem for three
    comparisons comprising insular lizard populations.
    The top two comparisons are pairs of populations for which we are interested
    in comparing their time of divergence.
