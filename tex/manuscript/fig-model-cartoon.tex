\embedWidthFigure{1.0}{../images/model-cartoons/mixed-model-description.pdf}{
    ...
    \jedit{}{%
    These five models are illustrated to the right, with the number of events with unique
    times (\nevents) ranging from 1--3; the enlarged example model is indicated with a border.}
    The event time
    (\etime[1] and \etime[2])
